            ...
            <section className="contato-formulario" aria-label="Formulário">
                ...
                <form className="form" action="./contato.html" onSubmit={handleSubmit}>
                    ...
                    <div className="">
                        ...
                        <input type="text" id="nome" name="nome" placeholder="Seu nome" onInput={handleInput}/>
                    </div>
                    <div className="">
                        <label htmlFor="telefone">Telefone</label>
                        <input type="text" id="telefone" name="telefone" placeholder="(21) 9999-9999" onInput={handleInput}/>
                    </div>
